...
class User(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    assignment_rules = relationship("AssignmentRule", back_populates="owner")
    recurring_tasks = relationship("RecurringTask", back_populates="owner", foreign_keys="[RecurringTask.owner_id]")
